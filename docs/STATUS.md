...
- **Source footprint:** 156 Rust source modules (server.rs decomposition ongoing — `server.rs` now ~33,670 lines after extracting 14 dedicated `server_*` submodules including the latest `server_control_plane` and `server_alerts`)
