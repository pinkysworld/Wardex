...
- **Source footprint:** 157 Rust source modules (server.rs decomposition ongoing — `server.rs` now ~33,600 lines after extracting 15 dedicated `server_*` submodules including the latest `server_control_plane`, `server_alerts`, and `server_av`)
