...
- 117 automated tests (100 unit + 17 integration) covering all modules
- 10,000-sample benchmark test for detector performance at scale
- End-to-end HTTP API integration test suite (17 tests)
