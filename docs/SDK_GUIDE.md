...
The `v1.0.10` clients expose the same resilience/proof contracts used by the admin console and release gate, plus the release verification and deployment-confidence tranche:
...
client.release_upgrade_rehearsal(target_version="1.0.10")
